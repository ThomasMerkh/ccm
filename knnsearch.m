%Adapted from a MATLAB file exchange program written because this function is not built in for Octave
%Updated last by Thomas Merkh, tmerkh@ucla.edu on July 25th, 2017 for usage in the Convergent Cross Mapping code

function [neighborIds neighborDistances] = knnsearch(dataMatrix, queryMatrix, k)
%--------------------------------------------------------------------------
% Program to find the k - nearest neighbors (kNN) within a set of points, where k = E+2.
